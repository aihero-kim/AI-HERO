...
export function ParticleSphere() {
    ...
    const textures = useTexture([
        ...
        "https://images.unsplash.com/photo-1758478648528-61a41d58944b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw3Nix8fGVufDB8fHx8fA%3D%3D",
...
export function OrbitGallery() {
    return (
        <div className="w-full h-[500px] md:h-[700px] bg-transparent relative">
