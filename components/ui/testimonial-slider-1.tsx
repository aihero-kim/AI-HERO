            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-full">
                ...
                <div className="md:col-span-3 flex flex-col justify-between order-2 md:order-1">
                    <div className="flex flex-row md:flex-col justify-between md:justify-start space-x-4 md:space-x-0 md:space-y-4">
                        ...
                        <h2 className="text-sm font-medium tracking-widest uppercase md:[writing-mode:vertical-rl] md:rotate-180 hidden md:block">
                            Reviews
                        </h2>
                    </div>
                ...
                <div className="md:col-span-5 flex flex-col justify-between md:pl-8 order-3 md:order-3">
                    ...
                    <div className="relative overflow-hidden pt-4 md:pt-24 min-h-[200px]">
                        <AnimatePresence initial={false} custom={direction} mode="wait">
                            ...
                            >
                                ...
                                <blockquote className="mt-6 text-2xl md:text-3xl font-medium leading-snug text-gray-300 italic">
                                    "{activeReview.quote}"
                                </blockquote>
                            </motion.div>
                        </AnimatePresence>
                    ...
                    <div className="flex items-center space-x-2 mt-8 md:mt-0">
                        <Button
                            variant="outline"
                            size="icon"
                            className="rounded-full w-12 h-12 border-white/20 hover:border-primary text-white hover:text-primary transition-colors bg-white/5"
                            onClick={handlePrev}
                        ...
                        <Button
                            variant="default"
                            size="icon"
                            className="rounded-full w-12 h-12 bg-primary text-black hover:bg-white transition-all shadow-lg hover:shadow-primary/50"
                            onClick={handleNext}
